...
export const SECRET_STATE_KEYS = [
	...
	"memoryIndexOpenAiKey",
	"memoryIndexOpenAiCompatibleApiKey",
	"memoryIndexGeminiApiKey",
	"memoryIndexMistralApiKey",
	"memoryIndexVercelAiGatewayApiKey",
	"memoryIndexOpenRouterApiKey",
	"memoryIndexVoyageApiKey",
	"huggingFaceApiKey",
	"sambaNovaApiKey",
	"zaiApiKey",
	"fireworksApiKey",
